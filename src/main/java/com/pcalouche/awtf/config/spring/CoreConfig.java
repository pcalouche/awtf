...
import com.pcalouche.awtf.config.webdriver.WebDriverFactory;
import com.pcalouche.awtf.util.appConfig.*;
import com.pcalouche.awtf.util.enums.BrowserType;
...
@ComponentScan("com.pcalouche.awtf")
