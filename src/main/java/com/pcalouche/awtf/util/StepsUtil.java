...
import com.pcalouche.awtf.util.enums.HTMLInputType;
...
public class StepsUtil {
     ...
     *
     * @param locator the locator to search by
     ...
     *
     * @param parentWebElement the parent web element
     * @param locator          the locator to search by
     * @return true if element is present, false otherwise
     */
     ...
     *
     * @param description the description to search by
     ...
     *
     * @param formElement the form element to do input for
     * @param value       the value to form field to
     */
     ...
     *
     * @param formElement       the form element to verify the value of
     * @param value             the value to verify against the form element
        ...
        switch (htmlTag) {
            ...
            case select:
                ...
                for (WebElement webElement : selectedOptions) {
                    logger.info(" Item is " + webElement.getText() + " value is " + value + " alt value is " + webElement.getAttribute("text"));
                    if (matchValueExactly) {
                    ...
                    if (valueFound) {
                        logger.info("found on " + webElement.getText());
                        break;
                    }
                }
                if (matchValueExactly) {
    ...
    /**
     * @param verificationToPerform the verification to perform. valid values are just "see" and "do not see" right now
     * @param select                the select to verify the option for
     * @param description           the description of the select
     * @param value                 the option value to verify in the select
     * @param matchValueExactly     true to match the value exactly
     */
     ...
     *
     * @param description       the description to check the value for
     * @param value             the expected value for the given name
     * @param matchValueExactly true to match the value exactly
     */
     ...
     * @param htmlElementState the web element state to test
     ...
     *
     * @param text    the the text to look for
     * @param tableId the table ID to for the item in
     ...
     *
     * @param criteria the data table that has the criteria to match on
     * @param tableId  the table ID of the table to search in
    ...
    public List<WebElement> findTableRowsWithMatchingCriteria(RowAction rowAction, DataTable criteria, String tableId) {
        ...
        for (int i = 1; i < dataTableRowList.size(); i++) {
			 ...
			 */
            List<WebElement> initiallyMatchedRows = new ArrayList<>();
     ...
     *
     * @param rowAction the row action to evaluate
     * @param criteria  the data table that has the criteria to match on
     * @param tableId   the table ID of the table to search in
     ...
     *
     * @param messageTextToUse the message text to search for
