...
//        StepsUtilSpring stepsUtilSpring = ctx.getBean("coreStepsUtil", StepsUtilSpring.class);
        ...
        MyInterface one = ctx.getBean("MyImpl1", MyInterface.class);
        MyInterface two = ctx.getBean("MyImpl2", MyInterface.class);
        System.out.println(one.getMyString("myString"));
        System.out.println(two.getMyString("myString"));
    }
}
